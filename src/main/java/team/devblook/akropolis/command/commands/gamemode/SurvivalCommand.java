...
public class SurvivalCommand extends InjectableCommand {
    ...
    public void onCommand(CommandSender sender, String label, String[] args) {
        if (args.length == 0) {
            ...
            Message.GAMEMODE_CHANGE.sendFromWithReplacement(player, "gamemode", TextUtil.parse("SURVIVAL"));
            ...
            Message.GAMEMODE_CHANGE.sendFromWithReplacement(player, "gamemode", Component.text("SURVIVAL"));
