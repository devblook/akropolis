...
public class SpectatorCommand extends InjectableCommand {
    ...
    public void onCommand(CommandSender sender, String label, String[] args) {
        if (args.length == 0) {
            ...
            Message.GAMEMODE_CHANGE.sendFromWithReplacement(player, "gamemode", TextUtil.parse("SPECTATOR"));
            ...
            if (sender.getName().equals(player.getName())) {
                Message.GAMEMODE_CHANGE.sendFromWithReplacement(player, "gamemode", Component.text("SPECTATOR"));
            } else {
                Message.GAMEMODE_CHANGE.sendFromWithReplacement(player, "gamemode", Component.text("SPECTATOR"));
